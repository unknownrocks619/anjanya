    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-6">
                    <h3>
                        {{ __('admin/category/edit.edit') }} - {{ $category->category_name }}
                    </h3>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 d-flex justify-content-end">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{ route('admin.categories.list') }}" class="btn btn-warning">
                                    Back
                                </a>
                        ...
                        <div class="tab-content" id="pills-danger-tabContent">
                            @foreach ($tabs as $key => $content)
                                <div class="mt-4 tab-pane fade {{ $key == $current_tab ? 'active show' : '' }}"
                                    ...
                                    @include('backend.category.tabs.' . $key, [
                                        'content' => $content,
                                        'category' => $category,
                                    ])
                                </div>
