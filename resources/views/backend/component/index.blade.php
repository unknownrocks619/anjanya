                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="action">
                                                    <li class="edit">
                                                        <a
                                                            href="{{ route('admin.components.common.edit', ['webcomponent' => $component]) }}">
                                                    ...
                                                    <li class="delete">
                                                        <a href="#" data-confirm="Are you sure?" class="data-confirm"
                                                            data-method="post"
                                                            data-action="{{ route('admin.components.common.delete-common-component', ['webComponent' => $component->getKey()]) }}"><i
