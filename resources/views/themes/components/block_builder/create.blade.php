<div class="row align-items-center">
                            ...
                            <div class="card work-desk rounded border-0 shadow-lg overflow-hidden">
                                <div class="row d-flex justify-content-center position-absolute image-button">
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="primary_image_value" class="form-control component_field">
                                        <a href="" onclick="clearImage({source:'primary'});event.preventDefault();"  data-image="primary" class="delete-image btn-danger btn-sm d-none">
                                ...
                                <img src="https://www.bootdey.com/image/241x362/FFB6C1/000000" class="img-fluid primary-placeholder" alt="Image" />
                                <img src="https://www.bootdey.com/image/241x362/FFB6C1/000000" style="height:362px; width:241px;" class="img-fluid primary-display d-none" alt="Image" />
                            ...
                            <div class="card work-desk rounded border-0 shadow-lg overflow-hidden">
                                <div class="row d-flex justify-content-center position-absolute image-button">
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="secondary_image_value" class="form-control component_field">
                                        <a href="" data-image="secondary" onclick="clearImage({source:'secondary'});event.preventDefault();" class="delete-image btn-danger btn-sm d-none">
                                            <i class="fa fa-trash"></i>
                                            Remove Image
                                        </a>
                                ...
                                <img src="https://www.bootdey.com/image/337x450/87CEFA/000000" class="img-fluid secondary-placeholder" alt="Image" />
                                <img src="https://www.bootdey.com/image/241x362/FFB6C1/000000" style="width:450px; height:337px" class="img-fluid secondary-display d-none" alt="Image" />
                            ...
                            <div class="card work-desk rounded border-0 shadow-lg overflow-hidden">
                                <div class="row d-flex justify-content-center position-absolute image-button">
                                    <div class="col-md-12">
                                        ...
                                        <input type="hidden" name="third_image_value" class="form-control component_field">
                                        <a href="#" onclick="clearImage({source:'third'});event.preventDefault();" data-image="third" class="delete-image btn-danger btn-sm d-none">
                                            <i class="fa fa-trash"></i>
                                            Remove Image
                                        </a>
                                ...
                                <img src="https://www.bootdey.com/image/600x250/FF7F50/000000" class="img-fluid third-placeholder" alt="Image" />
                                <img src="https://www.bootdey.com/image/600x401/FF7F50/000000" style="width:600px;height:250px;" class="img-fluid third-display d-none" alt="Image" />
                                <div class="img-overlay bg-dark"></div>
                            </div>
                        </div>
                        <!--end col-->
        ...
        <div class="col-lg-6 col-md-6 col-12 order-1 order-md-2">
            <div class="section-title ml-lg-5">
                <h5 name="subtitle" class="text-custom font-weight-normal mb-3 tinymce-subtitle component_field tiny-mce">About Us</h5>
                <h4 name="heading" class="title mb-4 tinymce-heading component_field tiny-mce">Our mission is to <br />
                    make your life easier.
                </h4>
                <div name="description" class="text-muted mb-0 tinymce-body mt-3 py-3 component_field tiny-mce">Lorem, ipsum dolor sit amet consectetur adipisicing elit quod debitis praesentium pariatur temporibus ipsa, cum quidem obcaecati sunt?</div>
            </div>
        </div>
        <!--end col-->
    </div>
