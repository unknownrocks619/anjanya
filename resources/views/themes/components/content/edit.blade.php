            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="tiny-mce component_field" name="heading"
                            value="{{ $componentValue['heading'] }}" />
                    </div>
                </div>
            </div>

            <textarea rows="80" class="description component_field tiny-mce" name="description">{!! $componentValue['description'] !!}</textarea>
        </div>
        <!--end row-->
    </div>
    <!--end col-->
