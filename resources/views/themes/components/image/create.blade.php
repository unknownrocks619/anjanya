<div class="row mb-4 align-items-center d-none left-image-content-original d-none">
    <div class="col-lg-6 mb-4 mb-lg-0">
        <div class="lc-block text-center">
            <img class="img-fluid w-50" src="https://cdn.livecanvas.com/media/svg/isometric/app_development_SVG.svg"
                srcset="" sizes="" width="" height="">
        </div><!-- /lc-block -->
        <button class="btn-xs btn-primary  upload_image_button">
            <i class="fas fa-cloud-upload-alt"></i>
            Upload Image
        </button>
        <button class="btn-xs btn-danger remove_image_button d-none">
    ...
    <div class="col-lg-6 p-lg-6">
        <div class="lc-block mb-5">
            <div editable="rich">
                ...
                <p class="lead"><br>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse a lacus est.
                    Etiam diam metus.</p>
            </div>
        </div><!-- /lc-block -->
        <!-- /lc-block -->
...
<div class="right-image-content-original d-none row mb-4 align-items-center">
    <div class="col-lg-6 mb-4 mb-lg-0 order-lg-1">
        <div class="lc-block text-center">
            <img class="img-fluid w-50" src="https://cdn.livecanvas.com/media/svg/isometric/Startup_SVG.svg"
                srcset="" sizes="" width="" height="">
        </div><!-- /lc-block -->
    </div><!-- /col -->
    <div class="col-lg-6 p-lg-6">
...
<input type="hidden" name="_component_name" value="image" class="component_field  d-none">
<input type="hidden" name="_action" value="store" class="component_field d-none">
<div class=" lc-block d-flex d-none bullets-copy d-none">
    <div class="bullets d-inline-flex">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                class="text-primary" viewBox="0 0 16 16" lc-helper="svg-icon">
                <path
        ...
        <div class="ms-3 align-self-center bullet-" editable="rich">
            <p>Sample bullet content</p>
        </div>
    </div>
...
<div class="row image-content-wrapper d-none">
        ...
        <div class="col-lg-6 mb-4 mb-lg-0 image-button-wrapper">
            <div class="lc-block text-center">
                <img class="img-fluid w-50"
                    src="https://cdn.livecanvas.com/media/svg/isometric/app_development_SVG.svg" srcset=""
                    sizes="" width="" height="">
                <input type="file" name="image_upload_file" class="image_content_upload d-none">
                <input type="hidden" name="image[]"
                    value="https://cdn.livecanvas.com/media/svg/isometric/app_development_SVG.svg"
        ...
        <div class="col-lg-6 p-lg-6">
            <div class="lc-block mb-5">
                <div editable="rich">
                    ...
                    <h1 name="heading[]" class="display-6 fw-bold text-dark  component_field">Boost your Creativity
                    </h1>
                    <div name="description[]" class="lead component_field "><br>Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit. Suspendisse a lacus est. Etiam diam metus.</div>
                </div>
            </div><!-- /lc-block -->
            <!-- /lc-block -->
            <div class="bullets-wrapper">
                    ...
                    <div class=" bullets  d-inline-flex ">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                fill="currentColor" class="text-primary" viewBox="0 0 16 16" lc-helper="svg-icon">
                                <path
                                    d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z">
                                </path>
                            </svg>
                        ...
                        <div name="bullets[0][]" class=" ms-3 align-self-center component_field" editable="rich">
                            Bullet point one
                        </div>
                    </div>
                    <div class="align-self-center">
                ...
                <div class="lc-block d-flex">
                    <div class="d-inline-flex bullets ">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                fill="currentColor" class="text-primary" viewBox="0 0 16 16" lc-helper="svg-icon">
                                <path
    ...
    <div class="main-content-wrapper right-image-content row mb-4 align-items-center" data-count="1">
        <div class="col-lg-6 mb-4 mb-lg-0 order-lg-1 image-button-wrapper">
            <div class="lc-block text-center">
                <img class="img-fluid w-50"
                    data-original-image="https://cdn.livecanvas.com/media/svg/isometric/Startup_SVG.svg"
                    src="https://cdn.livecanvas.com/media/svg/isometric/Startup_SVG.svg" srcset=""
                    sizes="" width="" height="">
                <input type="file" name="image_upload_file" class="image_content_upload d-none">
                <input type="hidden" name="image[]"
                    value="https://cdn.livecanvas.com/media/svg/isometric/Startup_SVG.svg"
                    class="component_field form-control">
            </div><!-- /lc-block -->
            <button type="button" class="btn-xs btn-primary d-block upload_image_button">
                <i class="fas fa-cloud-upload-alt"></i>
                Upload Image
            </button>
            <button type="button" class="btn-xs btn-danger remove_image_button d-none">
        ...
        <div class="col-lg-6 p-lg-6">
            <div class="lc-block mb-5">
                <div editable="rich">
                    ...
                    <h2 name="heading[]" class=" component_field display-6 fw-bold text-dark">Increase your Sales</h2>

                    <div name="description[]" class="component_field lead ">Lorem ipsum dolor sit amet,
                        consectetur adipiscing elit. Suspendisse a lacus est. Etiam diam metus.</div>
                </div>
            </div><!-- /lc-block -->
            <!-- /lc-block -->
            <div class="bullets-wrapper">
                <div class="lc-block d-flex">
                    <div class="d-inline-flex bullets ">
                        ...
                        <div name="bullets[1][]" class="ms-3 align-self-center component_field" editable="rich">
                            Bullet Point one
                        </div>
                    </div>
                    <div class="align-self-center">
                ...
                <div class=" lc-block d-flex">
                    ...
                    <div class="align-self-center">
                        <button type="button" class="btn-xs btn-danger  image-content-remove-bullet">
                            <i class="fa fa-trash"></i>
                        </button>
                    </div>
                </div>
...
<script>
    ...
    //     $(_bulletsCopy).find('.bullet-').removeClass('bullet-').addClass('')
