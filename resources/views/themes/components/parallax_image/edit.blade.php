...
<div class="row mt-2">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="section_height" class="form-control component_field">
                <option value="100vh" @if($componentValue['section_height'] == '100vh') selected @endif>100%</option>
                <option value="90vh" @if($componentValue['section_height'] == '90vh') selected @endif>90%</option>
                <option value="75vh" @if($componentValue['section_height'] == '75vh') selected @endif>75%</option>
                <option value="50vh" @if($componentValue['section_height'] == '50vh') selected @endif>50%</option>
                <option value="25vh" @if($componentValue['section_height'] == '25vh') selected @endif>25%</option>
            </select>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="container_class" class="form-control component_field">
                <option value="container"   @if($componentValue['container_class'] == '100vh') selected @endif>Compact</option>
                <option value="container-fluid"  @if($componentValue['container_class'] == '100vh') selected @endif>full</option>
            </select>
        </div>
    </div>
</div>
