...
<div class="jumbotron parallax" id="parallax-static">
    ...
    <input type="hidden" name="background_image" value="https://cdn.pixabay.com/photo/2015/09/09/16/05/forest-931706_1280.jpg" class="form-control d-none component_field" />
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="section_height" class="form-control component_field">
                <option value="100vh" selected>100%</option>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="container_class" class="form-control component_field">
                <option value="container" selected>Compact</option>
                <option value="container-fluid">full</option>
            </select>
        </div>
    </div>
</div>
