        ...
        <div class="row text-dark">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Full Name" onchange="contactUsPreview(this)"
                           name="full_name_label" class="form-control component_field">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="">Label for Email Field</label>
                    <input type="text" value="Email" onchange="contactUsPreview(this)"
                           name="email_label" class="form-control component_field">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Subject" onchange="contactUsPreview(this)"
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Submit" onchange="contactUsPreview(this)"
