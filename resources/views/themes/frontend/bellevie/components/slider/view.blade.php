@php
    ...
    $sliders = \App\Models\SliderAlbum::with([
...
<header class="header slider-fade  d-none  d-none">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 offset-md-1">
                                    ...
                                    <div class="butn-light mt-30 mb-30"> <a href="/room"
                                            data-scroll-nav="1"><span>Rooms & Suites</span></a> </div>
                                </div>
                            </div>
                        </div>
                    </div>
