...
<div class="jumbotron parallax" id="parallax-static">
    ...
    <div class="lead">
        <div class="row d-flex justify-content-center">
            <div class="col-md-5">
                <input value="{{$componentValue['promo_video']}}" type="text" name="promotional_video_link" id="promotional_video_link" class="form-control component_field" placeholder="Promotional Video Link (Only Youtube)" />
            </div>
        </div>
    </div>
</div>
