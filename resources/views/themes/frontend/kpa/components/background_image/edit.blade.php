...
<div class="container-fluid bg-light mt-3 p-4">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" value="{{$subtitle}}" name="subtitle" id="subtitle" class="form-control component_field" placeholder="Building Business From Scratch">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" value="{{$title}}" name="title" id="" class=" tiny-mce text-dark component_field">
            </div>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="first_button_label" @isset($button) value="{{$button['label']}}" @endif id="button_text" class="component_field border " placeholder="Button Text" />
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <h5 for="" class="text-dark">Button Link</h5>
                <input type="url" name="first_button_link" @isset($button) value="{{$butotn['link']}}" @endisset id="button_link" class="form-control component_field border" placeholder="Button Link" />
            </div>
        </div>
    </div>
    ...
    <div class="row my-4">
        <div class="col-md-12">
            ...
            <textarea name="description"  class="component_field form-control tiny-mce text-dark">{!! $description !!}</textarea>
        </div>
    </div>
