    <?php 
        $subHeading = isset($subHeading) ? $subHeading : 'Sub Heading';
        $heading  = isset($heading) ? $heading : 'How to manage your heading';
        $description = isset($description) ? $description : '';
        $events = isset($events) ? $events : [];
        $backgroundImage = isset($backgroundImage) ? $backgroundImage : asset('frontend/kpa/assets/images/service/bg-03.jpg')
    ?>
    ...
    <div class="rts-accordion-area service rts-section-gap">
        <div class="accordion-service-bg bg_image ptb--120 ptb_md--80 ptb_sm--60" style="background-image: url({{$backgroundImage}})">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
