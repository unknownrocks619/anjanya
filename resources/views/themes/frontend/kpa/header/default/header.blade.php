        ...
        <div class="main-header">
            <div class="content">
                <div class="header-left">
                    <a class="thumbnail" href="{{ \App\Classes\Helpers\SystemSetting::basic_configuration('host') }}">
                        ...
                        @if(\App\Classes\Helpers\SystemSetting::primary_contact_info('primary_contact_number'))
                            <div class="number-area">
                                ...
                                <a href="tel:{{\App\Classes\Helpers\SystemSetting::primary_contact_info('primary_contact_number')}}">
                                    <h6 class="call">{{\App\Classes\Helpers\SystemSetting::primary_contact_info('primary_contact_number')}}</h6>
                                </a>
                            </div>
                        @endif
                    </div>
                    @if(\App\Classes\Helpers\Menu::parentMenu()->where('menu_type','register')->first())
                    <a class="rts-btn btn-primary-2 menu-block-none" href='/register'>
