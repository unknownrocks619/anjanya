        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="heading" value="Contact Us" id="heading"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control component_field">Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit.</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="row text-dark">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Full Name" onchange="contactUsPreview(this)" name="full_name_label"
                        class="form-control component_field">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Email" onchange="contactUsPreview(this)" name="email_label"
                        class="form-control component_field">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Subject" onchange="contactUsPreview(this)" name="subject_label"
                        class="form-control component_field">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Type Your Message" onchange="contactUsPreview(this)"
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" value="Submit" onchange="contactUsPreview(this)" name="button_text"
                        class="form-control component_field">
                </div>
            </div>
        </div>
                ...
                <div class="row text-dark">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input value="Thank-You, Message Sent ." type="text" onchange="contactUsPreview(this)"
