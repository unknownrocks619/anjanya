<div class="row g-0 right alteration-right-original d-none">
    <div data-reset-background="https://images.unsplash.com/photo-1558985590-e84f133009b2?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1352&amp;q=80"
        lc-helper="background" class="col-lg-6 order-lg-2 alteration-image-display"
...
<div class="alternation-container-wrapper d-none">
    <div class="row g-0 right alteration-row">
        <div data-reset-background="https://images.unsplash.com/photo-1558985590-e84f133009b2?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1352&amp;q=80"
            ...
            <button type="button" onclick="resetContainer(this)"
                class="alteration-remove_image_button btn-sm btn-danger d-none">
                <i class="fa fa-trash"></i>
                Delete Image
            </button>
        </div>
        <div class="col-lg-6 order-lg-1 my-auto px-5 py-5">
            <div class="lc-block">
                <div editable="rich">
                    <h1 name="heading[]" class="component_field tiny-mce">Your Title goes here</h1>
                    <div class="lead component_field tiny-mce" name="description[]">Lorem ipsum dolor sit amet Neque
                        porro quisquam est qui dolorem Lorem int ipsum
                        dolor sit amet when an unknown printer took a galley of type. Vivamus id tempor felis. Cras
                        sagittis mi sit amet malesuada mollis. Mauris porroinit consectetur cursus tortor vel
                        interdum.</div>
                </div>
    ...
    <div class="row g-0 left alteration-row">
        <div lc-helper="background" class="col-lg-6"
            ...
            style="min-height: 45vh; background-size: cover;background-position: center; background-image: url('https://images.unsplash.com/photo-1491926626787-62db157af940?ixlib=rb-1.2.1&amp;q=80&amp;fm=jpg&amp;crop=entropy&amp;cs=tinysrgb&amp;w=1080&amp;h=768&amp;fit=crop&amp;ixid=eyJhcHBfaWQiOjM3ODR9');">
            <input type="hidden"
                value="https://images.unsplash.com/photo-1491926626787-62db157af940?ixlib=rb-1.2.1&amp;q=80&amp;fm=jpg&amp;crop=entropy&amp;cs=tinysrgb&amp;w=1080&amp;h=768&amp;fit=crop&amp;ixid=eyJhcHBfaWQiOjM3ODR9"
                name="image_display_value[]" class="d-none form-control component_field" />
            <input type="file" name="image_upload_file" class="d-none form-control" />
            <button type="button" class="alteration-upload_image_button btn-sm btn-primary">
                <i class="fa fa-image"></i>
                Upload Image
        ...
        <div class="col-lg-6 my-auto px-5 py-5">
            ...
            <div class="lc-block">
                <div editable="rich">
                    <h1 class="component_field tiny-mce" name="heading[]">Your Title goes here</h1>
                    <div name="description[]" class="lead component_field tiny-mce">Lorem ipsum dolor sit amet Neque
                        porro quisquam est qui dolorem Lorem int ipsum
                        dolor sit amet when an unknown printer took a galley of type. Vivamus id tempor felis. Cras
                        sagittis mi sit amet malesuada mollis. Mauris porroinit consectetur cursus tortor vel
                        interdum.</div>
...
<div class="row mt-2 d-none">
    <div class="col-md-12">
        <button type="button" class="btn btn-primary w-100 bg-light add-alternation-content-section">Add More
            Section</button>
    </div>
</div>
