...
@endphp
<div class="row g-0 right alteration-right-original d-none my-5">
    <div data-reset-background="https://images.unsplash.com/photo-1558985590-e84f133009b2?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1352&amp;q=80"
        lc-helper="background" class="col-lg-12 order-lg-1 alteration-image-display"
        ...
        <input type="hidden"
            value="https://images.unsplash.com/photo-1558985590-e84f133009b2?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1352&amp;q=80"
            name="image_display_value[]" class="d-none form-control" />
    ...
    <div class="col-lg-12 order-lg-2 my-auto">
...
<div class="row g-0 left alteration-left-original d-none">
    <div data-reset-background="https://images.unsplash.com/photo-1491926626787-62db157af940?ixlib=rb-1.2.1&amp;q=80&amp;fm=jpg&amp;crop=entropy&amp;cs=tinysrgb&amp;w=1080&amp;h=768&amp;fit=crop&amp;ixid=eyJhcHBfaWQiOjM3ODR9"
        lc-helper="background" class="col-lg-6"
    ...
    <div class="col-lg-6 my-auto px-5 py-5">
        ...
        <div class="lc-block">
            <div editable="rich">
                ...
                <div name="description[]" class="lead">Lorem ipsum dolor sit amet Neque porro quisquam est qui dolorem
                    Lorem int ipsum
...
<div class="alternation-container-wrapper">
    @foreach ($componentValue as $component)
        <div class="row g-0 right alteration-row border-bottom my-5">
            <div data-reset-background="https://images.unsplash.com/photo-1558985590-e84f133009b2?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1352&amp;q=80"
                lc-helper="background" class="col-lg-12 order-lg-1 "
                ...
                <input type="hidden" name="image_display_value[]"
                    @if ($component['image']) value="{{ $component['image'] }}" @endif
                    class="d-none form-control component_field" />
                <input type="file" name="image_upload_file" class="d-none form-control" />
                <button type="button"
                    class="alteration-upload_image_button btn-sm btn-primary @if ($component['image']) d-none @endif">
                    <i class="fa fa-image"></i>
                    Upload Image
                </button>
                <button type="button" onclick="resetContainer(this)"
                    class="alteration-remove_image_button btn-sm btn-danger @if (!$component['image']) d-none @endif">
                    <i class="fa fa-trash"></i>
                    Delete Image
                </button>
            </div>
            <div class="col-lg-12 order-lg-2 my-auto mt-4">
                <button class="btn btn-danger my-3 alteration-remove-section">Remove Section</button>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 fs-4">
                        <div class="form-group">
                            <label>Description</label>
                            <textarea name="description[]" class="form-control component_field tiny-mce">{!! $component['description'] !!}</textarea>
...
<div class="row mt-2">
    <div class="col-md-12">
        <button type="button" onclick="addAlternation()"
            class="btn btn-primary w-100 bg-light add-alternation-content-section">Add More
            Section</button>
    </div>
</div>
<script type="text/javascript">
    ...
    function resetContainer(params) {
        ...
        $(_closestDiv).css({
            "background-image": "url(" + _resetUrl + ")"
        });
    ...
    function addAlternation() {
        ...
        let _appendContent = $('.alteration-right-original').clone();
        // } else {
        //     _appendContent = $('.alteration-left-original').clone();
        // }

        $(_appendContent).find('input[name="heading[]"]').addClass('component_field');
        $(_appendContent).find('textarea[name="description[]"]').addClass('component_field').addClass(
            'tiny-mce')
        $(_appendContent).find('input[name="image_display_value[]"]').addClass('component_field');
        $(_containerWrapper).append(_appendContent);
        $(_appendContent).removeClass('d-none').removeClass('alteration-right-original').removeClass(
            'alteration-left-original').addClass('alteration-row');
    ...
    $(document).on('change', 'input[name=image_upload_file]', function(event) {
        ...
        if (file) {
            ...
            axios.post('/admin/components/common/upload-image/alternation', formData, {
                ...
                $(_closestDiv).css({
                    "background-image": "url(" + _response.params.image + ")"
                });
                ...
                $(_closestDiv).find('button.alteration-remove_image_button').attr('onclick',
                    "resetContainer(this)");
