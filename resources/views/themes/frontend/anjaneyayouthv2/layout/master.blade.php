...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("frontend/{$user_theme->theme_name()}/css/swiper.min.css") }}">
...
<body>
    {{-- {!! $user_theme->partials('loader/loader') !!} --}}
    {!! $user_theme->header() !!}
    @yield('main')
    ...
    <script src="{{ asset("frontend/{$user_theme->theme_name()}/js/swiper.min.js") }}"></script>
