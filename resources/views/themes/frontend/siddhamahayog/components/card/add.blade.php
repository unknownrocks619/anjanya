<div class="bg-light px-2 py-2 text-dark">
    <div class="component-container">
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-4 card_layout d-none">
                <div class="form-group">
        ...
        <div class="row my-2">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="background_type" class="form-control component_field">
                        <option value="colour" selected>Background Colour</option>
                        <option value="image">Background Image</option>
                    </select>
                </div>
            </div>

            <div class="col-md-4 background_type colour">
                <div class="form-group">
            ...
            <div class="col-md-4 background_type image d-none">
                <label for="">Background Image</label>
                <input type="file" name="background_image_upload" class="form-control background_image_upload">
                <input type="hidden" name="background_image" class="component_field" value="" />
            </div>
            <div class="col-md-4">
                <img src="" class="background-image-preview" style="max-height: 250px; overflow: hidden">
            </div>
