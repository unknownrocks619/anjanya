    ...
    <div class="card-body">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="layout_type" id="layout_type" class="form-control component_field">
                            <option value="boxed" @if($componentValue['layout_type'] == 'boxed') selected @endif>Boxed</option>
                            <option value="full-width"  @if($componentValue['layout_type'] == 'full-width') selected @endif>Full Width</option>
                            <option value="general"  @if($componentValue['layout_type'] == 'general') selected @endif>General</option>
                        </select>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="col-lg-4 my-3">
                ...
                <input type="hidden" name="video_image" class="component_field" value="{{$componentValue['video_poster']}}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$componentValue['background-text']}}" name="background_text" class="form-control component_field"/>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$componentValue['underline_text']}}" name="underline_world" class="form-control component_field">
                </div>
            </div>
        </div>
