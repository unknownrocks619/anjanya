<iframe id="background_image_add_iframe" sandbox="allow-scripts allow-same-origin"
    src="{{ route('frontend.pages.page', ['slug' => request()->get('param')]) }}" height="100vh" width="100%"
    loading='lazy' name="Background Image Preview">
</iframe>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 my-2 background_colour d-none background_type">
                        <div class="required">
                            ...
                            <input type="color" name="background_image_color" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" class="tiny-mce form-control component_field"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select multiple name="connector_component[]" id="connector_component"
