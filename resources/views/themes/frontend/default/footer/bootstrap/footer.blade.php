    ...
    <div class="container d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <div class="col-md-4 d-flex align-items-center">
            <div class="lc-block text-center mb-3 mb-md-0">
                ...
                <img class="img-fluid me-1"
                     src="{{\App\Classes\Helpers\SystemSetting::logo()}}"
                     style="max-height:50px;" alt="{{\App\Classes\Helpers\SystemSetting::basic_configuration('site_name')}}"/>
                </a>
                <span editable="inline" class="text-muted">© {{date('Y')}} {{\App\Classes\Helpers\SystemSetting::basic_configuration('site_name')}}</span>
            </div>
        </div>
        ...
        <div class="col-md-4 justify-content-end d-flex gap-3">
            @if (\App\Classes\Helpers\SystemSetting::social_media('social_facebook'))
                <div class="lc-block">
                    <a href="{{\App\Classes\Helpers\SystemSetting::social_media('social_facebook')}}">
            ...
            @if (\App\Classes\Helpers\SystemSetting::social_media('social_instagram'))
                <div class="lc-block">
                    <a href="{{ \App\Classes\Helpers\SystemSetting::social_media('social_instagram') }}">
            ...
            @if (\App\Classes\Helpers\SystemSetting::social_media('social_youtube'))
                <div class="lc-block">
                    <a href="{{\App\Classes\Helpers\SystemSetting::social_media('social_youtube')}}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill="currentColor" viewBox="0 0 16 16" style="" lc-helper="svg-icon">
