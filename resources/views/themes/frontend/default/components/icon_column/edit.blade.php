                                    ...
                                    <div class="col-md-12 pt-2">
                                        <div class='form-group'>
                                            @if($column_value['image'])
                                                <img src="{{$column_value['image']}}" style="max-height:25px; max-width: 25px;" />
                                            @endif
                                            <label>Uploaded Icon</label>
                                            <input type="file" name="upload_iconFile" class="form-control upload_iconFile">
                                            <input type="hidden" name="icon_image[{{$rowKey}}][{{$column_key}}]" class="component_field d-none" value="{{$column_value['image']}}">
                                        </div>
                                    </div>
