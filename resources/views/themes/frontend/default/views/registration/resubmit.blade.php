            ...
            <div class="container">
                <div class="card border-0" style="height:100% !important;box-shadow: none">
                    <div class="row">
                        <div class="col-md-12">
                            <p>
                                To resubmit your application please provide your email address
                                used while filling your appliation form.
                                If you email address is validated. We will send you 8 digit code to verify.
                            </p>
                            <x-alert></x-alert>
                        </div>
                        <form action="{{ route('frontend.users.resubmit_application') }}" class="ajax-form" method="post">
                            <div class="row">
                                <div class='col-md-4'>
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input type="email" name="email" id="email"
                                            placeholder="Please type your email address here." class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
