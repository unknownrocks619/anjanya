...
window.setupTinyMceAll = function () {
    tinymce.init({
        ...
        toolbar: 'undo redo fullscreen| blocks fontfamily fontsize | forecolor backcolor removeformat | bold italic underline strikethrough | link image media table | align lineheight  | numlist bullist indent outdent | emoticons charmap | removeformat accordion',
