(function ($) {
    ...
    $(function () {
        ...
        let navState = sessionStorage.getItem('nav-state');
        if (navState === 'collapsed') {
            $('.main-panel').toggleClass('menu-collapsed');
        ...
        $('.navbar-toggler').on('click', function() {
            ...
            if ($('.main-panel').hasClass('menu-collapsed')) {
                sessionStorage.setItem('nav-state', 'collapsed');
            } else {
