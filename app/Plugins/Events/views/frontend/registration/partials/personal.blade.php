                            ...
                            <div class="ps-5">
                                    ...
                                    <div class="col-md-12  col-lg-6 col-sm-12">
                                        <div class="form-group mb-5">
                                            ...
                                            <input type="text" name="last_name"
                                                value="{{ session()->get('registration_detail')['last_name'] }}"
                                ...
                                <div class="row mt-2 my-2">
                                    <div class="col-lg-6 col-md-12  col-sm-12">
                                        <div class="form-group">
                                            <label class="d-block"
                                                for="gender">{{ __('web/registration/events.gender') }}
                                                <sup class="text-danger">*</sup>
                                            </label>
                                            <select name="gender" id="gender" class="form-control">
                                                <option value="male"
                                                    @if (session()->get('registration_detail')['gender'] == 'male') selected @endif>
                                                    {{ __('web/registration/events.male') }}</option>
                                                <option value="female"
                                                    @if (session()->get('registration_detail')['gender'] == 'female') selected @endif>
                                ...
                                <div class="row my-2">
                                    <div class="col-md-12 col-lg-6 ">
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country" class="form-control ajax-select-2"
                                                data-action="https://siddhamahayog.org/api/countries">
                                                @if (isset(session()->get('registration_detail')['country_label']))
                                                    <option
                                                        value="{{ session()->get('registration_detail')['country'] }}"
                                                        selected>
                                    ...
                                    <div class="col-md-12 col-lg-6 mt-2 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                value="{{ session()->get('registration_detail')['city'] }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="education" id="education" class="form-control ">
                                                <option value="primary"
                                                    @if (isset(session()->get('registration_detail')['meta']['education']['education']) &&
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                type="text" name="field_of_study" id="field_of_study"
                                                class="form-control ">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select onchange="window.Registration.referenceSource(this)"
                                            name="reference_source" id="reference_source" class="form-control">
                                            ...
                                            <option value="social-media"
                                                @if (isset(session()->get('registration_detail')['reference_source']) &&
                                                        session()->get('registration_detail')['reference_source'] == 'social-media') selected @endif>Social Media
                                            </option>
                                ...
                                <div
                                    class="col-md-12 mt-2 reference other  @if (
                                ...
                                <div
                                    class="col-md-12 mt-2 reference friend @if (
                                        !isset(session()->get('registration_detail')['reference_source']) ||
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="referer_relation"
