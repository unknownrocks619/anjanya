...
@php
    ...
    $associatedFiles = $event->associatedFiles;
    $banner_image = null;
    $welcome_image = null;
...
{{--                                        </li>--}}
            ...
            @if($associatedFiles->count())
                <div class="row my-4">
                    <div class="col-md-12">
                        <div class="eduvibe-widget eduvibe-widget-details mt--40">
                            <h5 class="title">Download Files</h5>
                            <div class="widget-content">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($associatedFiles as $associatedFile)
                                            @php
                                                $filename = $associatedFile->image->original_filename;
                                                $fullpath = $associatedFile->image->filepath;
                                            @endphp
                                            <tr>
                                                <td>
                                                    @if(strtoupper(pathinfo($filename,PATHINFO_EXTENSION)) == 'PDF')
                                                    ...
                                                    @endif
                                                    {{$associatedFile->title}}
                                                </td>
                                                <td class="text-right text-end">
                                                    <a href="{{route('frontend.media.download',['image_relation' => $associatedFile->getKey(),'image'=>$associatedFile->image])}}" class=" edu-btn text-right">
