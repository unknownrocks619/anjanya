                                        ...
                                        <div class="form-group d-flex align-items-center mt-1">
                                            <div class="m-t-15 m-checkbox-inline">
                                                <div class="form-check form-check-inline checkbox checkbox-dark mb-0">
                                                    <input checked="" class="form-check-input" name="active" id="active" type="checkbox" data-bs-original-title="" title="Active">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="datetime" name="event_start" id="event_start" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="event_end_date">Event End</label>
                                            <input type="datetime" name="event_end" id="event_end" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
