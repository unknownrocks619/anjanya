                ...
                <tr>
                    <td>
                                            ...
                                            <td class="column column-1" width="100%"
                                                ...
                                                <table class="paragraph_block block-2" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad">
                                                            <div
                                                                style="color:#44464a;font-family:'Playfair Display',Georgia,serif;font-size:30px;line-height:120%;text-align:center;mso-line-height-alt:36px;">
                                                                <p style="margin: 0; word-break: break-word;"><span>New Booking Request !</span>
                                                                </p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                        ...
                                                        <td class="pad">
                                                            <div class="alignment" align="center"
                                                                 style="line-height:10px"><img
                                                                    ...
                                                                    width="136" alt="Separator" title="Separator"></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td class="pad">
                                                            <div
                                                                ...
                                                                <p style="margin: 0; word-break: break-word;">Full Name: <span style="color:#c4a07a;"><strong>{{$params['full_name']}}</strong></span>
                                                                </p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <table class="paragraph_block block-2" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad">
                                                            <div
                                                                style="color:#44464a;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">Email Address
                                                                    {{$params['email_address']}}</p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td class="pad">
                                                            <div
                                                                ...
                                                                <p style="margin: 0; word-break: break-word;">Check In Date</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                            ...
                                            <td class="column column-3" width="25%"
                                                ...
                                                <table class="paragraph_block block-1" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad">
                                                            <div
                                                                style="color:#c4a07a;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">
                                                                    Check Out Date</p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="paragraph_block block-1" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad">
                                                            <div
                                                                style="color:#c4a07a;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">Adult</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <table class="paragraph_block block-1" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad">
                                                            <div
                                                                style="color:#c4a07a;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">Children</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <table class="paragraph_block block-1" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad"
                                                            ...
                                                            <div
                                                                style="color:#393d47;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">{{$params['check_in']}}</p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="paragraph_block block-1" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad"
                                                            ...
                                                            <div
                                                                style="color:#393d47;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">{{$params['check_out']}}</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                ...
                                                <table class="paragraph_block block-1" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad"
                                                            ...
                                                            <div
                                                                style="color:#393d47;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">{{$params['adult_count']}}</p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <table class="paragraph_block block-1" width="100%" border="0"
                                                    ...
                                                    <tr>
                                                        <td class="pad"
                                                            ...
                                                            <div
                                                                style="color:#393d47;font-family:Nunito, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                                <p style="margin: 0; word-break: break-word;">{{$params['child_count']}}</p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td class="pad"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="margin: 0; word-break: break-word;">Date: {{date('Y-m-d')}}</p></div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                        ...
                        <table class="row row-24" align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff;margin-top: 10px">
                            <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td class="alignment"
                                                                        ...
                                                                        <table class="icons-inner"
                                                                            ...
                                                                            <tbody>
                                                                            <tr>
                                                                                <td style="font-family: 'Inter', sans-serif; font-size: 15px; color: #1e0e4b; vertical-align: middle; letter-spacing: undefined; text-align: center;">
                                                                                    <a href="http://designedwithbeefree.com/"
                                                                                       target="_blank"
                                                                                       style="color: #1e0e4b; text-decoration: none;">&copy; Hotel Bellevie</a></td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
